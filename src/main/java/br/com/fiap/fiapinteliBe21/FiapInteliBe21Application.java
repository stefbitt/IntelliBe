...
public class FiapInteliBe21Application implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente c1 = new Cliente(11222333000244l,"PJ","Consultoria Estefani Ltda","estefani@gmail.com","Rua Bragança,92","torre 1 apto 128","Jd Abril","SBCampo","SP","Brasil","065000123");
		Cliente c2 = new Cliente(33222333000255l,"PJ","Consultoria Verônica Ltda","ve@gmail.com","Rua Mooca,22","apto 128","Jd Conceição","Sto Andre","SP","Brasil","065000123");
		
		Departamento d1 = new Departamento(null, "Depto TI - Sistemas de Cobrança",c1);
		Departamento d2 = new Departamento(null, "Depto Marketing", c1);
		Departamento d3 = new Departamento(null, "Depto Recursos Humanos", c1);
		Departamento d4 = new Departamento(null, "TI Informações Tecnológicas", c2);
		Departamento d5 = new Departamento(null, "IG Informações Gerenciais", c2);
